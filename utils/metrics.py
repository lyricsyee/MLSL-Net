...
class AverageMeter:
    """"
    class to be an average meter for any average metric, 
...
class AverageMeterList:
    ...
    @property
    def val(self):
        return np.around(np.array(self.avg), decimals=3)

    @property
    def mean(self):
        return np.mean(np.array(self.avg))
